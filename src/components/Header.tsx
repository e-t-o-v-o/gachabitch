  ...
  return (
    <header className={`py-4 ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>
      <div className="container mx-auto px-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold">GachaBitch</h1>
        <div className="flex space-x-4 items-center">
        <span className="text-sm">Collection: {collectionSize}/51 <span className="text-xs">({((collectionSize / 51) * 100).toFixed(1)}%)</span></span>
